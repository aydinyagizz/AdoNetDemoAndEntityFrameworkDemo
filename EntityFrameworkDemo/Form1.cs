...
namespace EntityFrameworkDemo
{
    public partial class Form1 : Form
    {
        ...
        {
            // bu şekilde küçük büyük harf duyarlılığı oluyor. her iki tarafa da ToLower() eklediğimizde bu sorun ortadan kalkacaktır.
            //dgwProducts.DataSource = _productDal.GetAll().Where(p=>p.Name.ToLower().Contains(key.ToLower())).ToList();

            //TODO: direkt veritabanından sorgu yapmak için; bunu da ProductDal içerisinde GetByName metodunda yaptık
